...
func connectDB() *gorm.DB {
	db, err := gorm.Open("postgres", "host=127.0.0.1 port=5432 user=animesh.g dbname=bankingapp sslmode=disable")
...
func createAccounts() {
	...
	users := [2]User{
		{Username: "Animesh", Email: "animesh@gmail.com"},
		{Username: "Michael", Email: "michael@yahoo.com"},
	}
